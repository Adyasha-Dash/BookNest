  ...
  return (
    <>
      ...
      <aside
        ...
        aria-label="Sidebar"
      >
        <div class="h-full px-3 py-4 overflow-y-auto bg-lime-100 dark:bg-gray-800">
          <Link
            to="/"
            className="text-2xl font-bold text-black flex items-center gap-2"
          >
            <FaBlog className="inline-block text-[#674636] mr-2" />{" "}
            <span className="text-[#674636]"> BookNest</span>
          </Link>
          <br />

          <ul class="space-y-2 mt-6font-medium">
            <li>
              <a
              ...
              >
                <svg
                  class="w-5 h-5 text-black  transition duration-75 group-hover:text-gray-900 "
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 22 21"
